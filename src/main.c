...
int main() {
    ...
    const char* inputFile = "/workspaces/Exam_Scheduling_System/src/exam_schedule_input.txt";
    const char* outputFile = "/workspaces/Exam_Scheduling_System/src/exam_schedule_output.txt";
